 ...
 */
final class Version20230301040207 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE conducteurs (id INT AUTO_INCREMENT NOT NULL, idpersc_id INT DEFAULT NULL, idtrajetc_id INT NOT NULL, INDEX IDX_F4F8B850F22217AC (idpersc_id), INDEX IDX_F4F8B850D8AB945A (idtrajetc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trajets (id INT AUTO_INCREMENT NOT NULL, ville_depart INT DEFAULT NULL, villearrive_id INT DEFAULT NULL, idvoiture_id INT DEFAULT NULL, nbkilometers INT NOT NULL, datetotravel DATETIME DEFAULT NULL, INDEX IDX_FF2B5BA9DDDF1A2 (ville_depart), INDEX IDX_FF2B5BA918232926 (villearrive_id), INDEX IDX_FF2B5BA9CC28B580 (idvoiture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
